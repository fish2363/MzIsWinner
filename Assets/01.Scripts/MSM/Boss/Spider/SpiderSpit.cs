...
public class SpiderSpit : MonoBehaviour
{
    ...
    float[] angles = new float[] { 53, -53, 65.5f, -65.5f, -11.25f, -78f, 78f, 11.25f, -22.5f, 22.5f, -34f, 34f, 90, -90, 45, 0, -45, 110, -110, 100, -100, 117.5f, -117.5f, 125, -125, 132, -132, 137, -137 , 144 , -144 , 151 , -151 };
    public void Attack()
    {
